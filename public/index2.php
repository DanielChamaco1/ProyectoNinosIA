...
<?php
require_once "./regente/database.php";
$db = new Databasee();
$con = $db->conectar();
$regente = new Regente($db);
$regente = $regente->verRegentes();
?>
  <body>
  ...
  <div class="container-fluid">
    ...
    <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="border: 0cm; background-color: transparent;">
      <a class="navbar-brand" href="#">
        <img src="./img/fotoPrin.jpeg" style="border-radius: 50%; height: 40px; width: 40px; object-fit: cover;"> 
      </a>
    </button>
    ...
    <main class="container contenedor">
        <div class="p-3 rounded">
            <div class="row">
                <div class="col">
                    <h4>Regente
                        <a href="./regente/nuevo.php" class="btn btn-primary float-right">Nuevo</a>
                    </h4>
                </div>
            </div>
            ...
            <div class="row py-3">
                <div class="col">
                    <table class="table table-border">
                        ...
                        <tbody>
                            <?php foreach ($regente as $regente) : ?>
                                <tr>
                                    <td><?php echo $regente['id_regente']; ?></td>
                                    <td><?php echo $regente['nombres']; ?></td>
                                    <td><?php echo $regente['ap_paterno']; ?></td>
                                    <td><?php echo $regente['ap_materno']; ?></td>
                                    <td><?php echo $regente['edad']; ?></td>
                                    <td><?php echo $regente['direccion']; ?></td>
                                  
                                    <td>
                                    <td>
                                        <form action="./regente/actuaestado.php" method="POST" class="formEstado">
                                            <input type="hidden" name="id_regente" value="<?php echo $regente['id_regente']; ?>">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input estado-switch" id="onOffSwitch<?php echo $regente['id_regente']; ?>" name="estado" <?php echo ($regente['estado'] == 1) ? 'checked' : ''; ?>>
                                                <label class="custom-control-label" for="onOffSwitch<?php echo $regente['id_regente']; ?>"></label>
                                    ...
                                    <td><a href="./regente/editar.php?id=<?php echo $regente['id_regente'];?>" class="btn btn-warning">Editar</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
        ...
        <div class="p-3 rounded">
            <div class="row">
                <div class="col-12">
                    <h4>Estudiantes
                        <a href="./estudiantes/nuevo.php" class="btn btn-primary float-right">Nuevo</a>
                    </h4>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($estudiantes as $estudiante) : ?>
                                    <tr>
                                        ...
                                        <td>
                                        <td>
                                            <form action="./estudiantes/actuaestado.php" method="POST" class="formEstado">
                                        ...
                                        <td><a href="./estudiantes/editar.php?id=<?php echo $estudiante['id_estudiante']; ?>" class="btn btn-warning">Editar</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        <?php else : ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-3">
          <div class="col">
            <img src="./img/fotoPrin.jpeg" alt="Foto del Jefe" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%;">
          </div>
          <div class="col">
    ...
    <input type="text" class="form-control" id="inputCity">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="logoutButton" href="./index.php">Cerrar Sesion</button>
        <button type="button" class="btn btn-primary" id="btnInhabilitar">Inhabilitar Botón</button>
        <button type="button" class="btn btn-primary" id="btnhabilitar" ">habilitar Botón</button>
      </div>
    </div>
  </div>
</div>
